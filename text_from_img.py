...
esc = Label(text="Press Esc to exit full screen.", font=("Segoe Script", 8), bg='#F7FFF7')
esc.place(anchor='center', relx=0.5, rely=0.98) 
Label(text='Upload your image to extract text ₍^. .^₎Ⳋ', font=('Segoe Script', 18, "bold"), bg='#F7FFF7').place(anchor='center', relx=0.5, rely=0.05)  
Button(text='Convert', relief='flat', bg="#FAD4CE").place(anchor='n', relwidth=0.3, relx=0.8, rely=0.7) 
Button(text='Copy', command=lambda: gtc(), relief='flat', bg="#FAD4CE").place(anchor='n', relwidth=0.3, relx=0.8, rely=0.75) 
...
Button(button_frame, text="⟲ Left", command=lambda: rotate_fixed(90), relief='flat', bg="#FAD4CE").pack(side='left', padx=5)
Button(button_frame, text="⟳ Right", command=lambda: rotate_fixed(-90), relief='flat', bg="#FAD4CE").pack(side='left', padx=5)
Button(button_frame, text="⇋ Horizontal Flip", command=lambda: [flip_x.set(not flip_x.get()), draw_all()], relief='flat', bg="#FAD4CE").pack(side='left', padx=5)
Button(button_frame, text="⇅ Vertical Flip", command=lambda: [flip_y.set(not flip_y.get()), draw_all()], relief='flat', bg="#FAD4CE").pack(side='left', padx=5)
Button(button_frame, text="✅", command=confirm_crop, relief='flat', bg="#FAD4CE").pack(side='left', padx=5)
